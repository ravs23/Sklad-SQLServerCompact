...
namespace Sklad
{
    static class DataSetUtil
    {
        ...
        public static void LoadDBtoDataTable(DataTable table)
        {
            ...
            {
                SqlCeCommand cmd = new SqlCeCommand("SELECT * FROM " + table.TableName, connection);
                connection.Open();
        ...
        public static void LoadDBtoDataSet(DataSet dataset)
        {
            ...
            using (SqlCeConnection connection = new SqlCeConnection(DataBase.ConStrDB))
            {
                SqlCeCommand cmd = connection.CreateCommand();// ("SELECT * FROM " + table.TableName, connection);
                connection.Open();
        ...
        {
            SqlCeConnection connection = new SqlCeConnection(DataBase.ConStrDB);
